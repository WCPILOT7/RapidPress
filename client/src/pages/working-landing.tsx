      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <Card className="shadow-2xl border-0 bg-white/90 backdrop-blur-sm">
            ...
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-6 px-4 sm:px-8 md:px-12 lg:px-16">
                ...
                <Button 
                  type="submit" 
                  className="w-full h-14 text-base md:text-lg font-bold bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all duration-200" 
                  disabled={isLoading}
                >
        ...
        <div className="text-center mt-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 opacity-60">
            ...
            <div className="text-lg font-bold text-gray-400">MediaFlow</div>
            <div className="text-lg font-bold text-gray-400">StartupLab</div>
            <div className="text-lg font-bold text-gray-400">InnovatePR</div>
            <div className="text-lg font-bold text-gray-400">GlobalNews</div>
          </div>
        </div>
